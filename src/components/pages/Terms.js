      ...
      <div>
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              Prices estimated in quote may not be valid in the case of special service requirements that are requested
              by the client.
            </li>
            ...
            <li>
              ...
              their explanation, will follow with updated estimates. If you require additional services, you may add
              them for the corresponding fee. Price estimated by any project is what has been discussed thus far only.
            </li>
            <li>
            ...
            <li>
              ...
              the project requires additional outside resources, we may supply the necessary personnel. Additional
              charges will apply.
            </li>
            <li>
              If recreating or fixing is required on your current project, additional and/or different charges may
              apply.
            </li>
            <li>
            ...
            <li>
              ...
              termination fee of 10% &#40;of the total estimated amount thus far&#41;. Deposits and down payments made
              are non-refundable.
            </li>
            <li>
            ...
            <li>
              You, the client, agree that the designer/developer has the right to retain a copy of all documentation
              they create to be used in a portfolio. Web Blueprint Design agrees the work in the portfolio will remain
              in the possession of Web Blueprint Design at all times with the understanding of client confidentiality.
              Sensitive information will not be disclosed on any parties involved. Web Blueprint Design will agree, at
              the client’s requests, to remove the company’s name and any identifying information. This will only be a
              representative piece of the work the designer/developer creates. Client has the right to approve the
              piece&#40;s&#41; Web Blueprint Design chooses.
            </li>
            <li>
